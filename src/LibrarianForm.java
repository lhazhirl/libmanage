	...
	public LibrarianForm() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			String contact;
				...
				boolean isTrue = (name==null||name.trim().equals("")) || (password==null||password.trim().equals("")) || (email==null||email.trim().equals("")) || (address==null||address.trim().equals("")) || (city==null||city.trim().equals("")) || (contact==null||contact.trim().equals(""));
				if(isTrue) {
					JOptionPane.showMessageDialog(LibrarianForm.this,"Please fill in all the fields");
					frame.dispose();
					frame = new LibrarianForm();
					frame.setVisible(true);
				}
