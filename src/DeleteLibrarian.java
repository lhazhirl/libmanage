			...
			public void actionPerformed(ActionEvent e) {
				...
				if(sid==null||sid.trim().equals("")){
					...
					try {
						...
						JOptionPane.showMessageDialog(DeleteLibrarian.this,"Invalid input");
						break;
					}
					...
					if(i>0){
						...
						JOptionPane.showMessageDialog(DeleteLibrarian.this,"Id does not exist or input is invalid");
						break;
					}
